---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Family Weekend Radar template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Family Weekend Radar)
...
1. Open with a short CUSTOM welcome that names **Family Weekend Radar** and gives the
